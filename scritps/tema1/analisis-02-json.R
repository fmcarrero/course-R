...
currency.data[1:5,1:2]  # 5 registros y las dos primeras columnas
dat.1[c(2,5,8),]  #revuelve los registros 2, 5 y 8
dat.1[,c(2,5)]  # todos los registros y solo muetsra las columnas 2 y 5
